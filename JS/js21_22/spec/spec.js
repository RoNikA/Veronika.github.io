...
describe("Test", function() {
  it("test get questions", function() {
      ...
      var questionTmpl = "",
       ...
       $.ajax(
            {url: "http://Veronika.github.io/JS/js21_22/templates.json",
            async: false,
...
//      act
      test.initQestions("http://Veronika.github.io/JS/js21_22/questions.json");
...
//Сравниваю шаблоны
       $.ajax(
           ...
           test.initTemplate("http://Veronika.github.io/JS/js21_22/templates.json");
